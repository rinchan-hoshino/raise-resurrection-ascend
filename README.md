...
A Fabric and NeoForge mod for Minecraft 26.1.2 that replaces a player's first lethal outcome with a server-authoritative, damage-vulnerable downed state.
